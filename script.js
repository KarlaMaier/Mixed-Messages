const affirmations = {
    day: ['wonderful', 'exciting', 'amazing', 'excellent', 'a miracle', 'marvellous', 'magnificent'],
    message: [
        ...
        'I am making space for more success, love and wealth to come into my life',
...
function getRandomMessage() {
    ...
    return `Today is ${day}! ${message}. I will ${action}.`;
}
